...
% - Stripped away all functionality apart from SCIP.
% - Allow to build for Linux and Octave.
% - Rewrote interfaces to SCIP and SCIP-SDP.
% - Minor fixes to some files.

% The following history is kept for completeness:
